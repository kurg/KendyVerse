# Kevin van Rensburg 6/10/2022
# Copyright 2001
# Testing Kendy Startup Script version 23.07
# Changing version name to 23.07 
# kstart2307.py
# rearranged scripts to enable continuity.
# arranged order of Kendy1001.py, Wendy01.py, KendyDroid02.py and kstart2307.py
...
def Adventure():
    cls()
    print("")
    print("Program 8: KendyVerse  - future")
    print("The Adventure begins.....")
    print("")
    #print("Are you ready to enter the amazing adventure and gaming world")
    #print("- KendyVerse?")
...
def KendyRobot():
    cls()
    print("Program 9: KendyDroid - Bunker")
    print("")
