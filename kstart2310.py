# Kevin van Rensburg 3/8/2022
# Copyright 2001
# Testing Kendy Startup Script version 23.10
# Changing version name to 23.10 
# kstart2310.py
# rearranged scripts to enable continuity.
# arranged order of Kendy1001.py, Wendy01.py, KendyDroid02.py, kstart.py, and kstart2309.py updated to kstart2310.py
# swapped Chooser() Programs 6 to Program 11
# Testing scripts and relevant def's
...
def Adventure():
    cls()
    print("")
    print("Program 9: KendyVerse  - future")
    print("The Adventure begins.....")
    print("")
    #print("Are you ready to enter the amazing adventure and gaming world")
    #print("- KendyVerse?")
    #print("")
    print("NB::: TO ACCESS MY PROGRAM PLEASE OPEN THE FILE - KendyVerse1001.py")
    print("--------------------------------------------------------------")
    #print("Are you ready to enter the amazing adventure and gaming world")
    #print("- KendyVerse?")
    #print("")
...
def KendyDroid():
    cls()
    print("Program 7: KendyDroid - Bunker")
    print("")
    print("OK now it is time to fix the next steps!!")
    Continue()
    print("")
    print("NB::: TO ACCESS MY PROGRAM PLEASE OPEN THE FILE - KendyDroid02.py")
    print("--------------------------------------------------------------")
    go=input("Press any key to continue") 
    cls()
    print('''
    robot in the room..
    find something to charge...
    any panels...?
    look for an input jack, hole, or battery...
    ''')
    print("")
    Continue()
    #print("Welcome!")
...
def KendyPast():
    ...
    #go=input("Press any key to continue")
    #print("")
    print("NB::: TO ACCESS MY PROGRAM PLEASE OPEN THE FILE - KendyPast03.py")
    print("--------------------------------------------------------------")
    #sleep(2)
    go=input("Press any key to continue")
    KPastChooser();
...
def KendyInSpace():
    ...
    print("")
    #print("")
    #print("NB::: TO ACCESS MY PROGRAM PLEASE OPEN THE FILE - KendyInSpace01.py")
    #print("--------------------------------------------------------------")
    KFutChooser()
    #go=input("Press any key to continue")
    #Chooser();
