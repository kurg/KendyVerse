# Kevin van Rensburg 6/13/2022
# Copyright 2001
# Testing Kendy Startup Script version 23.08
# Changing version name to 23.08 
# kstart2308.py
# rearranged scripts to enable continuity.
# arranged order of Kendy1001.py, Wendy01.py, KendyDroid02.py, kstart.py, and kstart2307.py
...
def Kvep1():
    ...
    print("I help my friend to move to the large room. ")
...
def Kvep3():
    ...
    sleep(5)
    print("I can see the following images....")
