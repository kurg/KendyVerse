# Kevin van Rensburg 11/10/2021
# Copyright 2001
# Testing Startup Script version 0.16
# kstart16.py
# Working on Kvep7.
# added def's ALL(), ALI(), COMCODE(), core(), cipl() and AnotherCode().
# fixed and added scipt to Kvep7 and relevant def's
...
def Kvep7():
    ...
    print("[[I am looking forward to mmeting my CORE]]")
    print("<<before we access your core I want to make sure that your personaily is not overwritten>>")
    print("<<I like you!>>")
    ...
    print("I went to the cart and climbed in..")
    print("another descent in the elevator..this time it took really long and when the doors opened everything was dark..")
    Sleep(8)
    Continue()
    print("")
    print("[[Please walk 10 paces and put your hand on the left wall]]")
    print("a dim red light appeared in the middle of the dark passage..")
    print("as I moved forward the light extended .... the passage curved to the left and went down..")
    print("the light continued appering in fron of me, I looked back and there was no light behind me...")
    ...
    print("after a long walk the floor leveled out..")
    print(" the red light went to a wall... I stand at the wall and put my hand on it...")
    print("it tingles....")
    sleep(8)
    Continue()
    print("")
    ...
    print("another red plam... I put my hand on it and the wall slides to the left...")
    ...
    print("a strange helmet moves down and covers my head...the chaair reclines..")
    print("somthing that feels amost liquidy moves down from my head covering my body...")
    print("")
    sleep(8)
    Continue()
    cls()
    print("")
    print("everything seems hazy.. I lose consciousness...")
    print("I am in a white room with w blue screen in front of me...")
    ...
    print("This is where we continue on to the core and get it working etc!!")
