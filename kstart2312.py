# Kevin van Rensburg 10/12/2022
# Copyright 2001
# Testing Kendy Startup Script version 23.12
# Changing version name to 23.12 
# kstart2312.py
# rearranged scripts to enable continuity.
# added some scripting to def Kvep8()
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------
    #KendyPast - work in progress!! Oct 2022
...
def prolog():
   ...
   ''')
    ...
    life is still good....
    ''')
    print('''ok here we need too put kbuild() which
    has some info on building Kendy in the past
    a bit of history :)
    ''')
    kbuild()
    print('''ok here we need too put kstory() which
    has some continuation and how to move to the next part of the story....
    a bit of history :)
    ''')
    kstory()
    print("")
...
def KPep1():
    ...
    print("...prolog()...")
    go=input("Press any key to continue")    
    prolog() # checking and testing it 8/18/2022
    print("")
    go=input("Press any key to continue")
    print("..kbuild()...")
    print("")
