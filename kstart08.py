...
# Copyright 2001
# Testing Startup Script version 0.08
# kstart08.py
...
def Adventure():
    ...
    sleep(8)
    print("\033c")
    print("Program ..Start up, code running, Language, output to screen, Input from drive.")
    sleep(8)
    print("I have parts..hardware, software, understanding more now")
    sleep(8)
    print("\033c")
    print("Click, something turned on, power, I can feel power, electricity.")
    print("System..Operating System, code controlling my thoughts, output to screen.")
    ...
    sleep(15)
    print("\033c")
    print("ok, think.....Am I alone?")
    sleep(8)
    print("What can I do?")
    print("Awareness...")
    sleep(10)
    print("\033c")
    print("Searching through code, searching hardware, hmmm, devices.. hard drive, screen, keyboard, mouse, case.")
    ...
    print("CORRUPT")
    name=raw_input("WHO ARE YOU???")
    print("SYSTEM CORRUPT!! SYSTEM CORRUPTED")
...
def KendyVerse():
    ...
    print("A Universe of many worlds, constructs,")
    print ("and entities from earth, cyberspace, and the universe!")
    print("")
    go=raw_input("Press any key to continue")
    Adventure()
    #Chooser();
