# Kevin van Rensburg 11/16/2021
# Copyright 2001
# Testing Startup Script version 0.18
# kstart18.py
# Working on Kvep8.
...
def rd():
    ...
    print("[[Yes, Commander, it is 07:30 and Orentation will begin at 09:00 in the Briefing room next to the Coomand Centre..]]")
...
def bfot():
    cls()
    print("")
    print("3. Basic Facility Operations Training")
    print("""
    Core
    why Terra?
    food and transport
...
def srr():
    cls()
    print("")
    print("4. Sally Recuperation and rest")
    print("""
    Greet Sally
    show her the ropes
    food and a small history lesson
    sleep, eat and rest
    """)
    Continue()
def cft():
...
def Kvep8():
    ...
    print("[[would you like to see the agendastarting tomorrow ?>>")
    print("")
    Continue()
    cls()
    print("")
    ...
    1. Recuperative day
    2. Orientation
    3. Basic Facility Operations Training
    4. Sally Recuperation and rest
