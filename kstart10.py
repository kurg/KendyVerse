...
# Copyright 2001
# Testing Startup Script version 0.10
# kstart10.py
# Creatig new def KendyPart1()and clean up all related def's
# updated the following def's : Adventure(), Continue()
# Adding script and lines to AKendyPart1(), Adventure() 
...
def KendyPart2 ():
    ...
    print("The Story continues here in Episode2...")
    print("")
    sleep(5)
    print("\033c")
    ...
    print("you tell your wife everythig thart happened" )
    ...
    print("you try on some of the clean underfwaer...it fits!!...strange")
    print("you try on each of the items in the closet. The flightsuit is the most commfortable.")
    ...
    print("you press the [Enter] key.. a cursor appears on the screen...")
    sleep(10)
    Continue()
...
def KendyPart1():
    ...
    print("you undo the seatbelt and slowly climb out fo the seat.")
    ...
    print("you look around and see tht you are in a deep ditch")
    print("You udo your wifes seatbelt and lift her out of the seat.")
    sleep(10)
    ...
    print("check cellphone..no signal, battery ar 98%")
    sleep(10)
    Continue()
    print("\033c")
    ...
    Continue()
    print("\033c")
    print("use a seat leg, you push the cornet of the seat leg into the wheel and push")
    print("SCREECH..Creek, it slowly start to turn..then it is loose")
    ...
    print("you open it up and swing it over... you look into the hole")
    sleep(10)
    print("\033c")
    print("you see a dark tunnel going down with a ladder on one side.")
    print("You look around and make sure you have your jacket and everything else.")
    ...
    print("what is this??..whare are we??")
    ...
    Continue()
    print("\033c")
    print("opem cellphone..light.. its a tunnel .. moving forward")
    print("you walk down the tunnelfor about 100 metres and see another door")
    print("you open the door and walk in ... its slightly warmer here.. close the door behind you")
    print("you walk down the passage and there are rooms ahead to the lef and right.")
    print("you look in the first room and see what looks like soldiers quarters")
    ...
    print("you look in the closet and see another blanket and a set of flightsuits with strange looking helmets")
    print("the washbasin has a cabinet under it.. you open the cabinet")
    Continue()
    sleep(10)
    print("\033c")
    print("there is a candle, candleholder, matches, toothbrush, soap and a small towel there")
    ...
    print("you look into one of the large rooms..they have bigger closets and a desk with a double bed and an on suite bathroom")
    print("you find an empty backpack, and a duffel bag")
    print("the duffel bag has male and female underwear, toiletry bags, 6 glass bottles of water and 6 ration packs.")
    sleep(10)
    print("\033c")
    Continue()
    print("the dates on the ration packs are 25 August 1914")
    print("there are 2 sets of flightsuits with sranfge helments and what looks like 2 silver bodysuits")
    print("the other closet has 2 medium sized suits ...they look like a mix between a divers suit and a space suit")
    ...
    print("\033c")
    Continue()
    print("to be continued...soon in KendyPart2()")
    sleep(10)
