# Kevin van Rensburg 2/10/2023
# Copyright 2001
# Testing Kendy Startup Script version 23.23
# Changing version name to 23.23 
# kstart2323.py
# Starting to process and work on stroyline.
# added and changed some scripting to KendyVerse
# starting to make the code more readable and adding comments
...
def Kvep7():
    ...
    cls()
    print("")
    print("<<Good afternoon Commander TOMKVRKVR>>")
